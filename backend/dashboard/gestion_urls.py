...
urlpatterns = [
    ...
    path('promociones/', gestion_views.ProductPromotionListView.as_view(), name='promotions'),
    path('promociones/nueva/', gestion_views.ProductPromotionCreateView.as_view(), name='promotion-create'),
    path('promociones/<int:pk>/', gestion_views.ProductPromotionUpdateView.as_view(), name='promotion-edit'),
    path('promociones/<int:pk>/eliminar/', gestion_views.ProductPromotionDeleteView.as_view(), name='promotion-delete'),
    ...
    path('servicios/<int:pk>/activar/', gestion_views.LocalServiceActivateView.as_view(), name='local-service-activate'),
    path('servicios/<int:pk>/desactivar/', gestion_views.LocalServiceDeactivateView.as_view(), name='local-service-deactivate'),
    path('servicios/<int:pk>/eliminar/', gestion_views.LocalServiceDeleteView.as_view(), name='local-service-delete'),
    ...
    path('usuarios/<int:pk>/eliminar/', gestion_views.UserDeleteView.as_view(), name='user-delete'),
